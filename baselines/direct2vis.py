...
class Direct2vis:
    def __init__(self, api_key=None, model="gpt-4o-mini", system_prompt=None):
        ...
        self.model = model
        self.system_prompt = system_prompt or "Based on the user's query, generate Python code using `matplotlib.pyplot` and 'seaborn' to create the requested plot. Ensure the code is outputted within the format ```...```."
